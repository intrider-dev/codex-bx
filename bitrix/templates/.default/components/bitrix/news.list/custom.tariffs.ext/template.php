...
<?if($arResult['ITEMS']){?>
	...
	<?foreach($arResult['ITEMS'] as $item){?>
		<div class="universal-container tariff-container row justify-content-sm-between">
			<div class="tariff-item tariff-main-item col-12 col-sm-6 col-xl-3">
			...
			<div class="tariff-item tariff-price-item col-12 col-sm-4 col-xl-3 pt-3 pt-sm-2 pt-xl-0">
			...
			<div class="tariff-item tariff-service-item col-12 col-sm-6 col-xl-3">
				<div class="tariff-services pt-3 pt-sm-2 pt-xl-0">
					<?foreach($item['PROPERTIES']['SERVICES']['VALUE'] as $service){?>
						<div>
							<?=$service?>
						</div>
					<?}?>
			...
			<div class="tariff-item tariff-button-item col-12 col-sm-4 col-xl-3 align-items-center align-items-sm-start align-items-xl-end">
				<a href="#footer" class="tariff-button">
					Купить
				</a>
			</div>
		</div>
