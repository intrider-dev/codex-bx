...
echo '<title>СodEX — Маркет Битрикс24</title>';
?><?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"CACHE_TYPE" => "A",
		"COMPATIBLE_MODE" => "N",
		"COMPONENT_TEMPLATE" => "custom.tariff.sale",
		"DETAIL_URL" => "",
		"DISABLE_INIT_JS_IN_COMPONENT" => "N",
...
);?><?$APPLICATION->IncludeComponent("bitrix:catalog.section", "custom.tariff.sale.annuary", Array(
	"ACTION_VARIABLE" => "action",	// Название переменной, в которой передается действие
		...
		"IBLOCK_TYPE" => "codex_content",	// Тип инфоблока
	...
	Array(
		...
		"COMPONENT_TEMPLATE" => ".default",
		"EDIT_TEMPLATE" => "",
		"PATH" => "/include/details/podrobnoe-opisanie-market-bitriks24.php"
	)
);?><?$APPLICATION->IncludeComponent(
	"bitrix:catalog.section",
	"custom.tabs",
